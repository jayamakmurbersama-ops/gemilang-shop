      ...
      <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3">
        ...
        <div className="flex flex-1 items-center justify-end gap-2">
          <input
            ...
            className="w-full max-w-[230px] rounded-xl border-2 White-blue-500 bg-white/90 px-4 py-2 shadow-sm outline-none backdrop-blur focus:ring-4 focus:ring-blue-100"
          />
